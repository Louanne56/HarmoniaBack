/*
 * SeedData.cs - Script de peuplement initial de la base de données
 *
 * Ce fichier contient les données initiales pour peupler la base de données
 * avec des accords de musique, des progressions d'accords et des utilisateurs.
 */
...
public static class SeedData
{
    public static void seed()
    {
        ...
        // 1. CRÉATION DES ACCORDS DE BASE
        // Chaque accord a un identifiant unique, un nom, des diagrammes et des fichiers audio
        ...
        // Ajoute tous les accords à la base de données
        ...
        // 2. CRÉATION DES PROGRESSIONS D'ACCORDS
        // Définit des suites d'accords classées par tonalité, mode et style musical
        {
            ...
            context.ProgressionAccords.AddRange( // Ajoute les progressions à la base de données
                p1,
                p2,
                p3,
                p4,
        ...
        // Utilise le hachage de mot de passe intégré d'Identity
        ...
        context.Users.AddRange(user1, user2, user3); // Ajoute les utilisateurs à la base de données

        // 5. CRÉATION DES SUITES FAVORITES
        ...
        context.SuitesFavorites.AddRange(fav1, fav2); // Ajoute les favoris à la base de données

        context.SaveChanges(); // Enregistre tous les changements dans la base de données
    }
}
